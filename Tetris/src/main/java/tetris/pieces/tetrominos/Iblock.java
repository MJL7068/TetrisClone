...
public class Iblock extends Tetromino {
    ...
    public Iblock() {
        ...
        Block original1 = new Block(4, 0);
        originalPosition.add(original1);
        Block original2 = new Block(5, 0);
        originalPosition.add(original2);
        Block original3 = new Block(6, 0);
        originalPosition.add(original3);
        Block original4 = new Block(7, 0);
        ...
        Block block22 = new Block(0, 2);
        piece2.add(block22);
        Block block21 = new Block(0, 1);
        piece2.add(block21);
