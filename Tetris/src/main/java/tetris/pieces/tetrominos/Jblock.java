...
public class Jblock extends Tetromino {
    ...
    public Jblock() {
        ...
        piece2.add(block21);
        Block block24 = new Block(-1, -1);
        piece2.add(block24);
        Block block23 = new Block(0, -1);
        piece2.add(block23);

        super.addPosition(piece2);
        
        ArrayList<Block> piece3 = new ArrayList<>();
        Block block31 = new Block(-1, 0);
        piece3.add(block31);
        Block block32 = new Block(0, 0);
        piece3.add(block32);
        Block block33 = new Block(1, 0);
        piece3.add(block33);
        Block block34 = new Block(1, -1);
        piece3.add(block34);

        super.addPosition(piece3);
        
        ArrayList<Block> piece4 = new ArrayList<>();
        Block block41 = new Block(0, 1);
        piece4.add(block41);
        Block block42 = new Block(1, 1);
        piece4.add(block42);
        Block block43 = new Block(0, 0);
        piece4.add(block43);
        Block block244 = new Block(0, -1);
        piece4.add(block244);
